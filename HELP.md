...
* The original package name 'com.kreinto.microservices.spring-cloud-config-server' is invalid and this project uses 'com.kreinto.microservices.springcloudconfigserver' instead.
